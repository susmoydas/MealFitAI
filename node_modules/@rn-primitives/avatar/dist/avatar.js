...
var Root = ({ asChild, alt, ref, ...viewProps }) => {
  const [status, setStatus] = React.useState("error");
  const Component = asChild ? import_slot.Slot : import_react_native.View;
